...
Dieses Projekt ermöglicht es unabhängigen Privatpersonen, Teil des Fedivers zu werden, indem die Grundlagen für ein dezentrales soziales Netzwerk geschaffen werden. Administratoren sollen in der Lage sein, einen Node einzurichten, zu pflegen und allgemein zu administrieren. Dadurch wird es möglich, sich in Zukunft finanziell von großen Unternehmen unabhängig zu machen und nicht mehr auf ihre Regelwerke angewiesen zu sein.
